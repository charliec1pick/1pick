    ...
    <div>
      ...
      {showCreate && (
        <div style={s.formCard}>
          ...
          <div style={s.dateRow}>
            <div style={{flex:'none'}}><label style={s.label}>Session Start <span style={s.optional}>(optional)</span></label><input style={s.input} type="date" value={sessionStart} onChange={e=>setSessionStart(e.target.value)} /></div>
            <div style={{flex:'none'}}><label style={s.label}>Session End <span style={s.optional}>(optional)</span></label><input style={s.input} type="date" value={sessionEnd} onChange={e=>setSessionEnd(e.target.value)} /></div>
          </div>
                    ...
                    <div key={entry.id}>
                      ...
                      {showResetConfirm===pool.id && (
                        <div style={s.confirmCard}>
                          ...
                          <div style={s.dateRow}>
                            <div style={{flex:'none'}}><label style={{...s.label,color:'#c0392b'}}>Start <span style={s.optional}>(opt)</span></label><input style={s.input} type="date" value={newSessionStart} onChange={e=>setNewSessionStart(e.target.value)} /></div>
                            <div style={{flex:'none'}}><label style={{...s.label,color:'#c0392b'}}>End <span style={s.optional}>(opt)</span></label><input style={s.input} type="date" value={newSessionEnd} onChange={e=>setNewSessionEnd(e.target.value)} /></div>
                          </div>
...
const s = {
  ...
  heroInner:{display:'flex',flexDirection:'column',gap:'16px'},
  ...
  heroButtons:{display:'flex',gap:'8px',flexWrap:'wrap',width:'100%'},
  btnCreate:{padding:'10px 18px',background:'#4B2E83',border:'none',borderRadius:'9px',color:'#fff',fontFamily:"'Barlow Condensed',sans-serif",fontWeight:700,fontSize:'0.82rem',textTransform:'uppercase',letterSpacing:'1px',cursor:'pointer',flex:'1 1 auto',textAlign:'center',minWidth:'0'},
  btnJoin:{padding:'10px 18px',background:'rgba(255,255,255,0.08)',border:'1px solid rgba(255,255,255,0.2)',borderRadius:'9px',color:'rgba(255,255,255,0.8)',fontFamily:"'Barlow Condensed',sans-serif",fontWeight:700,fontSize:'0.82rem',textTransform:'uppercase',letterSpacing:'1px',cursor:'pointer',flex:'1 1 auto',textAlign:'center',minWidth:'0'},
  btnInvite:{padding:'10px 18px',background:'rgba(201,168,76,0.15)',border:'1px solid rgba(201,168,76,0.4)',borderRadius:'9px',color:'#C9A84C',fontFamily:"'Barlow Condensed',sans-serif",fontWeight:700,fontSize:'0.82rem',textTransform:'uppercase',letterSpacing:'1px',cursor:'pointer',flex:'1 1 100%',textAlign:'center'},
  ...
  poolCard:{background:'#fff',border:'1px solid #e2dfd8',borderRadius:'10px',padding:'14px 16px',marginTop:'4px',marginLeft:'12px',display:'flex',alignItems:'flex-start',gap:'10px',cursor:'pointer',flexWrap:'wrap'},
  ...
  confirmCard:{background:'#fff8f8',border:'1.5px solid rgba(192,57,43,0.3)',borderRadius:'12px',padding:'16px',marginTop:'4px',marginLeft:'12px'},
