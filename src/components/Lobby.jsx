...
const s = {
  ...
  confirmCard:{background:'#fff8f8',border:'1.5px solid rgba(192,57,43,0.3)',borderRadius:'12px',padding:'14px',marginTop:'4px',marginLeft:'12px',overflow:'hidden',boxSizing:'border-box',maxWidth:'calc(100% - 12px)'},
