    ...
    <div>
      ...
      {showCreate && (
        <div style={s.formCard}>
          ...
          <div style={s.dateRow}>
            <div style={{flex:1}}><label style={s.label}>Session Start <span style={s.optional}>(optional)</span></label><input style={s.input} type="date" value={sessionStart} onChange={e=>setSessionStart(e.target.value)} /></div>
            <div style={{flex:1}}><label style={s.label}>Session End <span style={s.optional}>(optional)</span></label><input style={s.input} type="date" value={sessionEnd} onChange={e=>setSessionEnd(e.target.value)} /></div>
          </div>
                    ...
                    <div key={entry.id}>
                      ...
                      {showResetConfirm===pool.id && (
                        <div style={s.confirmCard}>
                          ...
                          <div style={s.dateRow}>
                            <div style={{flex:1}}><label style={{...s.label,color:'#c0392b'}}>Start <span style={s.optional}>(opt)</span></label><input style={s.input} type="date" value={newSessionStart} onChange={e=>setNewSessionStart(e.target.value)} /></div>
                            <div style={{flex:1}}><label style={{...s.label,color:'#c0392b'}}>End <span style={s.optional}>(opt)</span></label><input style={s.input} type="date" value={newSessionEnd} onChange={e=>setNewSessionEnd(e.target.value)} /></div>
                          </div>
...
const s = {
  ...
  dateRow:{display:'flex',gap:'10px',marginBottom:'8px'},
