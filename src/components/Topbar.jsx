...
export default function Topbar({ profile, weekLabel }) {
  return (
    <div style={s.topbar}>
      ...
      <div style={s.right}>
        <div style={s.weekBadge}>{weekLabel}</div>
        <div style={s.userChip} onClick={() => supabase.auth.signOut({ scope:'local' })}>
...
const s = {
  ...
  weekBadge:{background:'rgba(255,255,255,0.07)',border:'1px solid rgba(255,255,255,0.12)',borderRadius:'6px',padding:'5px 12px',fontSize:'0.67rem',fontFamily:"'Barlow Condensed',sans-serif",color:'rgba(255,255,255,0.5)',textTransform:'uppercase',letterSpacing:'1.5px',whiteSpace:'nowrap'},
